...
prd = copy(JSON3.read(JSON.json(CSV.File("src/inputs/RILAs/Equitable/Structured_Capital_Income_Accelerated.csv") |> DataFrame)))
...
sci_std_a = Dict(:sci_std_a => merge(prd, gf, yf, f, s, w, rf, inc))